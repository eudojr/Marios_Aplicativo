<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index_administrador.aspx.cs" Inherits="Marios_Aplicativo.index_administrador" %>
	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				...
				<div class="queries">
					<p>Questions? Call us Toll-free!<span>Bienvenido </span><asp:Label ID="label_nombre_apellido" runat="server" Text="Label"></asp:Label></p>
				</div>
