<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="construir_plato.aspx.cs" Inherits="Marios_Aplicativo.construir_plato" %>
...
<!-- Controles -->
<link href="css/controles.css" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files -->
			...
			<div class="order-form-head text-center wow bounceInLeft" data-wow-delay="0.4s">
				...
				<div class="col-md-6 order-form-grids">
					...
					<div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <div class="Column">
                      <asp:DropDownList ID="dropdownlist_ensaladas" class="dropdown" runat="server" DataSourceID="Ensalada" 
                      DataTextField="Descripcion" DataValueField="ID_principal" data-settings='{"wrapperClass":"flat"}'>
                            </asp:DropDownList>

                            <asp:ObjectDataSource ID="Ensalada" runat="server" 
                                SelectMethod="cargar_combobox" TypeName="Marios_Aplicativo.Datos">
                                <SelectParameters>
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <div class="Column">
                      <asp:DropDownList ID="dropdownlist_acompanamiento" class="dropdown" runat="server" DataSourceID="Acompanamiento" 
                      DataTextField="Descripcion" DataValueField="ID_principal" data-settings='{"wrapperClass":"flat"}'>
                            </asp:DropDownList>                    
                          
					      <asp:ObjectDataSource ID="Acompanamiento" runat="server" 
                              SelectMethod="cargar_combobox" TypeName="Marios_Aplicativo.Datos">
                              <SelectParameters>
					...
					<div class="btnCustom">
                    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Crear Plato"/>
